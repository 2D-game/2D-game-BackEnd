...
export class Observer implements IObserver {
	...
	start() {
		this.lobbyPub.subscribe(LobbyEv.PLAYER_LIST_CHANGE, this.onPlayerListChange.bind(this))
	}

	stop() {
		this.lobbyPub.unsubscribe(LobbyEv.PLAYER_LIST_CHANGE, this.onPlayerListChange.bind(this))
	}
...
export class PlayerObserver implements IObserver {
	...
	start() {
		this.playerPub.subscribe(PlayerEv.PLAYER_CREATED, this.onPlayerConnect.bind(this))
		this.playerPub.subscribe(PlayerEv.PLAYER_READY, this.onPlayerReady.bind(this))
		this.playerPub.subscribe(PlayerEv.PLAYER_DISCONNECTED, this.onPlayerDisconnect.bind(this))
	}

	stop() {
		this.playerPub.unsubscribe(PlayerEv.PLAYER_CREATED, this.onPlayerConnect.bind(this))
		this.playerPub.unsubscribe(PlayerEv.PLAYER_READY, this.onPlayerReady.bind(this))
