...
export class LobbyObserver implements IObserver {
	...
	start() {
		this.lobbyPub.subscribe(LobbyEv.PLAYER_READINESS_CHANGE, this.onPlayerReadinessChange.bind(this))
	}

	stop() {
		this.lobbyPub.unsubscribe(LobbyEv.PLAYER_READINESS_CHANGE, this.onPlayerReadinessChange.bind(this))
	}
...
export class Observer implements IObserver {
	...
	start() {
		this.gamePub.subscribe(GameEv.PLAYER_LIST_CHANGE, this.onPlayerListChange.bind(this))
	}

	stop() {
		this.gamePub.unsubscribe(GameEv.PLAYER_LIST_CHANGE, this.onPlayerListChange.bind(this))
	}
