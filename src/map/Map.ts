import { IObject, NullObject, Type } from '../object'
...
export class Map implements Cloneable {
	...
	public getRandomEmptyCoords(): Coordinates {
		let x = Math.floor(Math.random() * this.width)
		let y = Math.floor(Math.random() * this.height)
		let coords = { x, y }
		const obj = this.getObjectAt(coords)
		if (obj && obj.getType() !== Type.NULL) {
